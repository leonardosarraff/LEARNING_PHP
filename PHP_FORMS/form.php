...
<html>
    ...
    <body>
        <?php
            //determine wheter phone number is valid and print
                ...
                $_POST["phone"]))
            {
                ...
                die();//Terminate the script excecution
            }
        ?><!--end PHP script-->

        <p>
            Hi <?php print($_POST["fname"]);?>. Thank you for completing
            the survey. You have been added to the
        ...
        <p>
            OS: <?php print($_POST["os"])?>
        </p>

        <p class="head">
            This is only a simple form. You have not been added to a mailing list.
        </p>
